...
class MainWidget(RelativeLayout):
    ...
    V_NB_LINES = 8
    V_LINES_SPACING = .4  # Pourcentage de la largeur de l'écran
    vertical_lines = []

    H_NB_LINES = 8
    H_LINES_SPACING = .15  # Pourcentage de la largeur de l'écran
    horizontal_lines = []
    ...
    def init_audio(self):
        ...
        self.sound_galaxy = SoundLoader.load('audio/menu_space.wav')
        self.sound_gameover_impact = SoundLoader.load('audio/gameover_impact.wav')
        self.sound_gameover_voice = SoundLoader.load('audio/gameover_voice.wav')
        self.sound_music1 = SoundLoader.load('audio/galaxy.wav')
    ...
    def on_menu_button_pressed(self):
        ...
        if self.sound_music1.state == "play":
